...
namespace MyBackEndProject_Asp.Net_Core_3._1_.Migrations
{
    ...
    [Migration("20200919050452_TakeVideoTableChangeRegularExpression")]
    partial class TakeVideoTableChangeRegularExpression
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyBackEndProject_Asp.Net_Core_3._1_.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<bool>("Studentoreacher")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("MyBackEndProject_Asp.Net_Core_3._1_.Models.UserCourses", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MyBackEndProject_Asp.Net_Core_3._1_.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MyBackEndProject_Asp.Net_Core_3._1_.Models.UserCourses", b =>
                {
                    b.HasOne("MyBackEndProject_Asp.Net_Core_3._1_.Models.Course", "Course")
                        .WithMany("UserCourses")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyBackEndProject_Asp.Net_Core_3._1_.Models.User", "User")
                        .WithMany("UserCourses")
                        .HasForeignKey("UserId");
                });
